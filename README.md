...
How it Works
Input: Paste 8 Discord usernames into the generator.

Shuffle: The app uses a Fisher-Yates shuffle to determine teams and traitors.

Encapsulation: Data is bundled into a JSON object containing name, team, role, and mission.

Encoding: The object is stringified, converted to Base64, and appended as a URL hash.

The Reveal: When a player opens their unique link, the app parses the hash and renders the parchment-themed view.
...
Navigate to Workers and Pages, select Create application, then Upload assets.
